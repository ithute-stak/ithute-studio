  ...
  return (
    <main className="ds-home">
      <header>
        ...
        <div className="ds-actions"><Link className="ds-button" href="/pdf-editor">PDF Studio</Link><Link className="ds-button" href="/templates">Templates</Link><Link className="ds-button primary" href="/editor">Open editor</Link></div>
      </header>
      <section className="ds-hero">
        ...
        <div className="ds-actions"><Link className="ds-button primary" href="/editor">Create a document</Link><Link className="ds-button" href="/pdf-editor">Edit a PDF</Link><Link className="ds-button" href="/templates">Browse templates</Link></div>
      </section>
