    ...
    with TestClient(app) as client:
        ...
        generated = client.post(
            ...
            json={
                ...
                "data": {"contact": {"fullName": "Sample Person"}},
            },
        )
        assert generated.status_code == 201
        body = generated.json()["body"]
        assert body["content"][0]["content"][0]["text"] == "Sample Person"


def test_document_optimistic_versioning():
    with TestClient(app) as client:
        document = {"schemaVersion":1,"workspaceId":"default","properties":{"title":"One"},"settings":{},"header":{"type":"doc","content":[]},"body":{"type":"doc","content":[]},"footer":{"type":"doc","content":[]},"variables":{},"version":1}
        created = client.post("/v1/documents", json=document).json()
        document_id = created["id"]

        saved = client.put(
            f"/v1/documents/{document_id}",
            json={"document": created, "expectedVersion": 1},
        )
